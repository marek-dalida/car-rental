...
class CarRentalApplicationTests {
    ...
    @Test
    void shouldDifferentClientRentSameCarInDifferentPeriods() {
        ...
        var rentStartDate2 = LocalDate.of(2026, 1, 21);
        var rentDays2 = 5;
        var carRent2 =  carRentalService.rentCar(car1.getId(), client2.getId(), rentStartDate2, rentDays2);
        var foundRent2 = carRentRepository.findById(carRent2.getId()).orElseThrow();
        assertNotNull(foundRent2);
        assertEquals(carRent2, foundRent2);
    }

    private Car addMockCar(String name, CarType carType) {
